...
public class Player_Vs_Player_3x3 extends AppCompatActivity  implements View.OnClickListener {
    ...
    //Media Player Variable to play Sound
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.start:
                /** Makes the views required to start the game invisible when game starts
                 * */
